   ...
   public void createAddressBookOwnerstable() {
    ...
    public void createContactsAddressBook(){
        try {
            String create = "CREATE TABLE ContactsAddressBook "
                    + "(abid NUMBER NOT NULL, cid NUMBER NOT NULL, "
                    + "PRIMARY KEY (abid, cid),"
                    + "FOREIGN KEY (abid) REFERENCES AddressBookOwners(id) ON DELETE CASCADE,"
            ...
            // Insert data into table
            String insert = "INSERT INTO ContactsAddressBook(abid, cid) "
                    + "values(?, ?)";
            ...
            System.out.println("ERROR in createContactsAddressBook() method: " + e);
        }
    }
    
    public ResultSet getContacts(String owner){
        try{
            String query = "SELECT contacts.id, contacts.cname, contacts.address, contacts.pnumber, contacts.email "
                            + "FROM Contacts, ContactsAddressBook, AddressBookOwners "
                            + "WHERE AddressBookOwners.id = ContactsAddressBook.abid AND "
                            + "ContactsAddressBook.cid = Contacts.id AND "
                            + "AddressBookOwners.name = ?";
            ...
            System.out.println("ERROR in getContacts() method: " + e);
        }
    ...
    public int getContactID() {
        ...
        try {
            ...
            System.out.println("ERROR in method getContactID() " 
                    + ex.getMessage());
        }
        return cid;
    }
    ...
    public int getOwnerID(String owner) {
        ...
        try {
            ...
            System.out.println("ERROR in method getOwnerID() " + ex.getMessage());
        }
        return num;
    }
    ...
    public void addToLinkTable(String owner) {
        ...
        try {
            ...
            System.out.println("ERROR in method addToLinkTable()  " 
                    + ex.getMessage());
        }
    }
}
